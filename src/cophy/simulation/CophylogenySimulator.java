...
public abstract class CophylogenySimulator<T extends AbstractCophylogenyModel> {
    ...
    public abstract Tree simulateTree();
    
    public abstract Tree simulateTree(final double until);
    
    public void resumeSimulation(final Tree tree, final double until) {
        
        if (!(tree instanceof SimpleTree))
            throw new RuntimeException("Tree not generated by a CophylogenySimulator.");
